...
- Starter catalogue now includes explicit Women, Men and Kids edits and categories.
...
## 3.5.0 - 2026-08-29
- Added premium editorial Journal AJAX archive and single-post presentation.
...
## 3.1.0 - 2026-08-28
- Added editorial collection mega menu, repaired Swiper/motion demo content and polished store shell styling.
- WooCommerce functionality remains centralized in wp-theme-woo-support.

## 3.0.0 — 2026-08-28

- Rebuilt editorial fashion source/design system and production build.
- Converted demo layouts to BBuilder + Bootstrap containers and Swiper hero content.
- Integrated the shared newsletter form in editorial/footer patterns.
- Centralized store behavior in WP Theme Woo Support 3.0.0.
- Added suite header/footer, mega-menu, AJAX search, dark mode and language presentation.
